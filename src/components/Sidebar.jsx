        ...
        <div className='px-6 w-[35%] h-[calc(100vh-6.625rem)] overflow-y-scroll overflow-x-hidden'>
            ...
            <div className='space-y-1 items-center'>
                {sidebarItems.map(item => {
                    return (
                        <div key={item.id} className='flex items-center space-x-4 hover:bg-gray-300 duration-300 rounded-xl p-1'>
            ...
            <br />
            <p className='text-xs text-gray-800 mt-3'>© 2024 Harshit Sharma</p>
        </div>
    )
}
